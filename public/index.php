...
switch ($page) {
    case 'classes':
        ...
        $product1 = new models\Product(1, 'Майка',150,1,'men','img/product_mini/Product_1.png','img/Product_1.png');
        $product2 = new models\Cloth(2,'Блузка',200,1,'women','img/product_mini/Product_2.png','img/Product_2.png',
